        ...
        <tr class="item-body">
            ...
            <td width="120px" rowspan="${o.totalNumber}">
                ...
                <c:if test="${o.status=='waitConfirm' }">
                    <a href="confirmPay?order.id=${o.id}" class="order-button blue">确认收货</a>
                </c:if>
                <c:if test="${o.status=='waitPay' }">
                    <a href="pay?order.id=${o.id}" class="order-button blue">付款</a>
                </c:if>

                <c:if test="${o.status=='waitDeliver' }">
                    <a href="#nowhere" class="order-button white">待发货</a>
                    <a href="deliver?order.id=${o.id}" class="order-button blue">自己发货</a>
                </c:if>
