        ...
        <table class="address-table">
            ...
            <tr>
                ...
                <td class="right-column"><textarea placeholder="建议您如实填写详细收货地址，例如接到名称，门牌号码，楼层和房间号等信息"
                                                   name="order.address"></textarea></td>
            </tr>
            <tr>
                <td class="left-column">邮政编码</td>
                <td class="right-column"><input type="text" placeholder="如果您不清楚邮递区号，请不要填写" name="order.post"></td>
            </tr>
            <tr>
                <td class="left-column">收货人姓名<span class="red-star">*</span></td>
                <td class="right-column"><input type="text" placeholder="长度不超过25个字符" name="order.receiver"></td>
            </tr>
            <tr>
                <td class="left-column">手机号码 <span class="red-star">*</span></td>
                <td class="right-column"><input type="text" placeholder="请输入11位手机号码" name="order.mobile"></td>
            </tr>
            </tbody>
        </table>
