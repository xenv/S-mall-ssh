    ...
    <table class="table table-hover table-striped">
        ...
        <c:forEach items="${products}" var="p" varStatus="vs">
            <tr>
                ...
                <td><a href="propertyValue/edit?product.id=${p.id}"><span class="glyphicon glyphicon-th-list"></span></a></td>
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="get" id="add-form" action="add">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="originalPrice" name="product.originalPrice"
                                   placeholder="请输入原价格">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nowPrice" name="product.nowPrice"
                                   placeholder="请输入现价格">
                        </div>
                    </div>
                    <div class="form-group">
