...
<div class="container" >
    ...
    <table class="table table-hover table-striped">
        ...
        <c:forEach items="${properties}" var="pt" varStatus="vs">
            <tr>
                <th scope="row">${pt.id}</th>
                <td>${pt.name}</td>
                <td><a href="edit?property.id=${pt.id}&category.id=${category.id}"><span class="glyphicon glyphicon-edit"></span></a></td>
                <td><a href="delete?property.id=${pt.id}&category.id=${category.id}" class="delete-button"><span class="glyphicon glyphicon-trash"></span></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="get" id="add-form" action="add">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" name="property.name"
                                   placeholder="请输入属性名字">
                        </div>
