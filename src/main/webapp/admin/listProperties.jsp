    ...
    <table class="table table-hover table-striped">
        ...
        <c:forEach items="${properties}" var="p" varStatus="vs">
            <tr>
                ...
                <td><a href="admin_property_delete?id=${p.id}" class="delete-button"><span class="glyphicon glyphicon-trash"></span></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    ...
    <div class="row" >
        <div class="panel panel-default" style="width: 500px;margin:auto">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="get" id="add-form" action="add" enctype="multipart/form-data">
